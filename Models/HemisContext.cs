...
public DbSet<BaiTapLon.Models.VCoCauToChuc2> VCoCauToChuc2 { get; set; } = default!;

public DbSet<BaiTapLon.Models._VDeAnDuAnChuongTrinh> _VDeAnDuAnChuongTrinh { get; set; } = default!;

public DbSet<BaiTapLon.Models._VDoanCongTac> _VDoanCongTac { get; set; } = default!;

public DbSet<BaiTapLon.Models._VGvduocCuDiDaoTao> _VGvduocCuDiDaoTao { get; set; } = default!;
